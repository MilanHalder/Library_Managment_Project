    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <form class="d-flex">
      ...
      <div class="logo">
        ...
        <form action="index.php" name="contactForm" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
        <div class="field_wrap">
            <font color="black">
                <label>Book Name:</label>
            </font>
            <input type="text" name="fname" placeholder="Enter Book Name" autocomplete="off">
        ...
        <font color="black">
            ...
            <input type="text" name="femail" placeholder="Enter Authors Name" autocomplete="off">
        ...
        <font color="black">
            ...
            <input type="text" name="fbook" placeholder="Enter Book Description" autocomplete="off">
            <div id="book_txt"></div>  
        </div>
        <div class="field_wrap">
            <font color="black">
            ...
            <select name='fdept' required>
                    <option disable>-Book Type-</option>
                    <option value="Computer Programming">Computer Programming</option>
                    <option value="Story Book">Story Book </option>
                    <option value="Cook Book">Cooking Book</option>
        ...
        <font color="black">
            ...
            <input type="file" name="fpassword" placeholder="Choose Image" autocomplete="off"><br><br>
            <div id="password_txt"></div> 
        </div>
        <input type="submit" value="Upload" class="submit" name="Upload">
        </form></center> 
...
<script src="js/custombu.js"></script>
