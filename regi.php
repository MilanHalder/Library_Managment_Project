        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <h1><b style="color:white;padding:0px 30px;"></b><b style="color:red;">LIBRARY </b><b style="color:blue;">ZONE</b><b style="color:white;padding:0px 45px;"></b></h1>
              ...
              <li class="nav-item">
              <div class="New_E">
                <a href="regi.php"><button type="button" class="btn btn-danger">Registration</button></a>
              </div>
              </li>
              </ul>
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <div class="New_E">
                <a href="logi.php"><button type="button" class="btn btn-outline-success">Student Login</button></a>
                </div>
              </li>
              </ul>
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(image/img5.jpg);">
			      </div>
              ...
              <form action="index.php" class="signin-form" name="contactForm" onsubmit="return validateForm()" method="post">
                ...
                <div class="New_E">
		          ...
		          <p class="text-center">A member? <a href="logi.php">Sign In</a></p>
		        </div>
		      </div>
				</div>
			</div>
